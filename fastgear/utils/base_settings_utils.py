...
class EnvBaseSettings(BaseSettings):
    ...
    @staticmethod
    def get_env_files(config_dir: Path, env_enum: type[StrEnum]) -> list[str]:
        candidates: list[Path] = [
            config_dir / ".env",
        ...
        for env in env_enum:
            candidates.append(config_dir / f".env.{env.value}")
            candidates.append(config_dir / f".env.{env.value}.local")
