...
class TestCustomEnumClass:
    ...
    def test_object_name_from_instance(self) -> None:
        enum_instance = TestCustomEnum.TestValueOne
        assert enum_instance.object_name() == TestCustomEnum.object_name()
